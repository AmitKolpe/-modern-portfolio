...
const projectsData = [
  {
    ...
    color: "#00ffff",
    description:
      "Developed scalable REST APIs for patient management with FastAPI. Implemented CRUD operations, request validation with Pydantic, BMI calculation, and health classification.",
    technologies: ["Python", "FastAPI", "Pydantic"],
    github: "https://github.com/AmitKolpe/Patient-Management-System-API_FastAPI",
    demo: "",
    image: "",
  },
  {
    ...
    color: "#ff00ff",
    description:
      "Built an AI chatbot that answers questions from PDF documents using Retrieval-Augmented Generation. Implemented document chunking, semantic search, and RAG pipeline with Cerebras LLM.",
    technologies: ["Python", "LangChain", "RAG", "Cerebras LLM"],
    github: "https://github.com/AmitKolpe/chat-with-pdf-cerebras",
    demo: "",
    image: "",
  },
  {
    ...
    color: "#ffff00",
    description:
      "Built a content-based movie recommendation system using cosine similarity. Designed feature engineering and recommendation pipeline with Pandas and Scikit-Learn.",
    technologies: ["Python", "Pandas", "Scikit-Learn"],
    github: "https://github.com/AmitKolpe/Movie-Recommender-System",
    demo: "",
    image: "",
  },
  {
    ...
    color: "#00ff00",
    description:
      "Developed a regression model to predict house prices with data preprocessing, feature engineering, and model evaluation using Pandas and Scikit-Learn.",
    technologies: ["Python", "Pandas", "Scikit-Learn"],
    github: "https://github.com/AmitKolpe/House-price-prediction",
    demo: "",
    image: "",
  },
]
