...
const skillsData = [
  {
    ...
    color: "#3776AB",
    position: [3, 0, 0],
    description: "Primary language for AI/ML development, data analysis, scripting, and backend services",
  },
  {
    ...
    color: "#FF6F00",
    position: [2.1, 2.1, 0],
    description: "Scikit-Learn, model training, evaluation, feature engineering, and prediction pipelines",
  },
  {
    name: "LangChain",
    category: "AI/ML",
    ...
    color: "#00C58C",
    position: [0, 3, 0],
    description: "Building LLM-powered applications, RAG pipelines, chains, and agents",
  },
  {
    name: "FastAPI",
    category: "Backend",
    ...
    color: "#009688",
    position: [-2.1, 2.1, 0],
    description: "High-performance async REST APIs with Pydantic validation and auto-docs",
  },
  {
    name: "SQL & DBMS",
    category: "Data",
    ...
    color: "#4479A1",
    position: [-3, 0, 0],
    description: "Database design, normalization, joins, indexing, and query optimization",
  },
  {
    name: "Pandas",
    ...
    color: "#150458",
    position: [-2.1, -2.1, 0],
    description: "Data manipulation, cleaning, transformation, and exploratory data analysis",
  },
  {
    name: "NLP & LLMs",
    category: "AI/ML",
    ...
    color: "#E91E63",
    position: [0, -3, 0],
    description: "Natural Language Processing, Large Language Models, text embeddings, and semantic search",
  },
  {
    name: "Git & GitHub",
