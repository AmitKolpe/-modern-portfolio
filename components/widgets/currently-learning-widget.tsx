...
const learningData = [
  { name: "Advanced LLM Fine-tuning", progress: 70, icon: "🧠" },
  { name: "LangChain & LangGraph", progress: 80, icon: "🔗" },
  { name: "Computer Vision", progress: 55, icon: "👁️" },
  { name: "MLOps & Deployment", progress: 45, icon: "🚀" },
]
    ...
    <Card className="glass-morphism border-white/20 hover:border-purple-400/50 transition-all duration-300">
      ...
      <CardContent className="space-y-4">
        ...
        >
          ...
          <div className="text-white/80">Building end-to-end AI pipelines with MLOps best practices</div>
        </motion.div>
      </CardContent>
    </Card>
  )
